...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("<b>𝟷. تــأكد من كتابة اسم المسلسل صحيح\n2. تــأكد من اضافة كلمة <u>مسلسل</u> قبل الاسم او <u>اي رقم</u> بعد الاسم\n\n3. لو مش لاقي المسلسل الادمن هيضيفه في اسرع وقت</b>", InlineKeyboardButton(text="❌ 𝖭𝗈 𝖬𝗈𝗋𝖾 𝖯𝖺𝗀𝖾𝗌 𝖠𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 ! ❌",callback_data="pages"), reply_to_message_id=msg.id)
