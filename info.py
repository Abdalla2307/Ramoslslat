...
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', "<b>⚠️ <u>لاستخدام البوت يرجي تخطي الرابط</u></b> ⚠️\n<code> 𝟭 اضغط علي 'استخدام البوت' من الزر\n 𝟮 يظهر لك رابط اضغط فتح\n 𝟯 بعد تخطي الرابط يرسل قناة اضغط انضمام\n 𝟰 بعدها استخدم البوت مجانا اكثر من 25 مسلسل</code>\n<i>       <u>💥تخطي الرابط مرة واحده فقط💥</u></i>")
...
# Others
IMDB_DELET_TIME = is_enabled((environ.get('IMDB_DELET_TIME', "True")), True)
