...
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', "<b><a>⚠️ <u>لاستخدام البوت يرجي تخطي الرابط<u> ⚠️\n❶ اضغط علي 'استخدام البوت' من الزر\n❷ يظهر لك رابط اضغط فتح\n➌ بعد تخطي الرابط يرسل قناة اضغط انضمام\n➍ بعدها استخدم البوت مجانا اكثر من 25 مسلسل</b></a>\n<i>       <u>تخطي الرابط مرة واحده فقط </u></i>")
